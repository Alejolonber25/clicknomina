...
(function ($) {
	...
	function bannerSlider() {
		...
		banner.slick({
			...
			dots: false,
			swipe: true,
			nextArrow: '<button class="slick-arrow next-arrow"><i class="fas fa-greater-than"></i></button>',
			prevArrow: '<button class="slick-arrow prev-arrow"><i class="fas fa-less-than"></i></button>',
			responsive: [{
				breakpoint: 768,
				settings: {
					arrows: false
